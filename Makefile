...
app-bin:
	$(CC) $(INCLUDE) -o bin/zbd obj/comun.o obj/runtime.o obj/teclado.o obj/pantalla.o obj/monitor_bluetooth.o obj/monitor_orientacion.o obj/monitor_teclado_usb.o obj/audio.o obj/config.o obj/main.o ${GTK_LIB}
	$(CC) $(INCLUDE) -o bin/zbd-tray obj/comun.o obj/runtime.o obj/teclado.o obj/pantalla.o obj/monitor_bluetooth.o obj/monitor_orientacion.o obj/monitor_teclado_usb.o obj/audio.o obj/config.o obj/gui_daemon.o ${GTK_LIB}
